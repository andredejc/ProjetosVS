...
/****** Object:  StoredProcedure [dbo].[sp_exe_CriaEstruturaTabela]    Script Date: 12/20/2016 14:32:11 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[sp_exe_CriaEstruturaTabela](  
 @TabelaBase NVARCHAR(100),  
 @AnoTabelaNova VARCHAR(4)  
)  
AS  

--------------------------------------------------------------------------------
-- Procedure que gera estrutura de tabela. É necessário que já exista uma tabela
-- base com a estrutura desejada. A procedure cria uma estrutura identica com o 
-- ano correspondente ao passado como parâmetro, incluindo PK e índices.
--------------------------------------------------------------------------------
